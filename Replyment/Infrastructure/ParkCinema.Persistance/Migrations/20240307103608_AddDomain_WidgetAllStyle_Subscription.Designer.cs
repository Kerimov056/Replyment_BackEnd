...
namespace Replyment.Persistance.Migrations
{
    ...
    [Migration("20240307103608_AddDomain_WidgetAllStyle_Subscription")]
    partial class AddDomain_WidgetAllStyle_Subscription
    {
            ...
            modelBuilder.Entity("Replyment.Domain.Entities.Domain", b =>
                {
                    b.HasOne("Replyment.Domain.Entities.AppUser", "AppUser")
                        .WithOne("Domain")
                        .HasForeignKey("Replyment.Domain.Entities.Domain", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
